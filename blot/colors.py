...
_custom_scales = {
    'qual': {
        ...
        'original': ['orange', 'blue', 'grassgreen', 'purple', 'red', 'teal', 'yellow', 'olive', 'salmon',
                     'lightblue2'],
        ...
        'henanigans': ['henanigans_cyan2', 'henanigans_red2', 'henanigans_green2', 'henanigans_blue2',
                       'henanigans_orange2',
                       'henanigans_purple2', 'henanigans_yellow2', 'henanigans_light2', 'henanigans_cyan1',
                       'henanigans_red1',
